...
public class infoManager : MonoBehaviour
{
	void Start ()
	{
		...
		PlayerName = this.transform.FindChild ("Name").GetComponent<Text> ();
		handType = this.transform.FindChild ("Hand").GetComponent<Text> ();
		HisCards = this.transform.FindChild ("Cards").transform;
	}
